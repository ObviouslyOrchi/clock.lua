if not getgenv().MTAPIMutex then game:GetService("Players").LocalPlayer:Kick("Please use the loader instead of the main script, thanks. .gg/GPVqBUmPb3")
...
Shop:CreateToggle({Name = "Teleport To All Cashier Spots [BETA]",CurrentValue = false,Callback = function(Value)
